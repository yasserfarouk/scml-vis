...
REM Repository: projects/scml-vis
echo Restoring: projects/scml-vis
if exist "projects\scml-vis\.git" (
    ...
    git clone "git@github.com:yasserfarouk/scml-vis.git" "projects\scml-vis"
    if errorlevel 1 (
